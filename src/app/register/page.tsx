    ...
    <div className="container-blog pt-16 pb-20">
      <div className="max-w-sm mx-auto">
        ...
        <div className="animate-fade-in-up">
          ...
          <h1 className="text-2xl font-semibold text-white tracking-tight mb-2">Criar conta</h1>
          ...
          <p className="mt-6 text-sm text-zinc-500">
            Já tem conta?{' '}
            <Link href="/login" className="text-zinc-200 hover:text-white underline underline-offset-4 decoration-zinc-700">
              Entrar
            </Link>
          </p>
        </div>
